...
def _build_html(run_dir, corpus, manifest_by_rank, summary_text):
    ...
    summary_block = _e(summary_text.strip()) if summary_text else "No summary.md found."
...
def render_artifact(run_dir, output=None):
    ...
    html_text = _build_html(run_dir, corpus, manifest_by_rank, summary_text)
